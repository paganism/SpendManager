 ...
 *
 */
public class DayExpenseCommand extends BotCommand {
    private static final String LOGTAG = IncomeCommand.class.getSimpleName();

    public DayExpenseCommand() {
        super("dayexpense", "Расход за день ");
    }
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        result1.append(in.dayConsumption(chat.getId().toString()));
