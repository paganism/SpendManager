 ...
 *
 */
public class WeekIncomeCommand extends BotCommand {
    private static final String LOGTAG = IncomeCommand.class.getSimpleName();

    public WeekIncomeCommand() {
        super("weekincome", "Доход за неделю ");
    }
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        result1.append(in.weekIncome(chat.getId().toString()));
