 ...
 *
 */
public class MonthExpenseCommand extends BotCommand {
    private static final String LOGTAG = IncomeCommand.class.getSimpleName();

    public MonthExpenseCommand() {
        super("monthexpense", "Расход за неделю ");
    }
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        result1.append(BalanceTelegram.monthConsumption(chat.getId().toString()));
