 ...
 *
 */
public class DelLastExpCommand  extends BotCommand {
    private static final String LOGTAG = IncomeCommand.class.getSimpleName();

    public DelLastExpCommand() {
        super("dellastexp", "Удалиь последнюю запись о расходе ");
    }
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        result1.append(in.delLastExpense(chat.getId().toString()));
