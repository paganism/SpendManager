 ...
 *
 */
public class MonthIncomeCommand extends BotCommand {
    private static final String LOGTAG = IncomeCommand.class.getSimpleName();

    public MonthIncomeCommand() {
        super("monthincome", "Доход за месяц ");
    }
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        result1.append(in.monthIncome(chat.getId().toString()));
